    ...
    try:
        ...
        if students:
            ...
            for student in students:
                stu = student_to_dict(student)
                student_dictionaries[student.full_name] = stu
                
            return {
                "success": True,
                "message": "Lấy danh sách sinh viên thành công",
                "data": student_dictionaries
            }
...
async def update_student(student_id: str, student_data: dict):
    ...
    update_data = {
        ...
        "face_encoding": student_data.get("face_encoding", student_obj["face_encoding"]),
    ...
    print("Cập nhật thành công:", update_data)
